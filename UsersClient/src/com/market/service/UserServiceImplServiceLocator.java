...
public class UserServiceImplServiceLocator extends org.apache.axis.client.Service implements com.market.service.UserServiceImplService {
    ...
    private java.lang.String UserServiceImpl_address = "http://localhost:8080/Users/services/UserServiceImpl";
    ...
    public com.market.service.UserServiceImpl getUserServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.market.service.UserServiceImpl getUserServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.market.service.UserServiceImplSoapBindingStub _stub = new com.market.service.UserServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.market.service.UserServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.market.service.UserServiceImplSoapBindingStub _stub = new com.market.service.UserServiceImplSoapBindingStub(new java.net.URL(UserServiceImpl_address), this);
                _stub.setPortName(getUserServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.market.com", "UserServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.market.com", "UserServiceImpl"));
        }
